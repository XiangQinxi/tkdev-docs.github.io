...
我们也可以去\ `pypi <https://pypi.org/project/tkinterDev/>`__\ 上面去找到想要的那个版本，
...
但是\ `我的网站 <https://xiangqinxi.github.io/tkinterDev/%E5%AE%89%E8%A3%85/>`__\ 里有讲解过，
你可以去\ `我的网站 <https://xiangqinxi.github.io/tkinterDev/%E5%AE%89%E8%A3%85/>`__\ 里去找到安装的。
...
但是如果这个方法报错，请将\ ``报错信息``\ 发到\ `我的邮箱 <mailto:XiangQinxi@outlook.com>`__\ 内，并且安装上面的方法进行安装即可。
